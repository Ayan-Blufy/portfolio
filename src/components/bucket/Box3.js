        ...
        <div className="bucket">
            ...
            <div className="p-2 w-full  lg:w-full ">
                <div className="box_col rounded shadow-lg p-10 cursor-pointer bag">
                    ...
                    <div className="mb-12">
                        <h4 className="text-green-300 text-xl font-poppins font-extrabold mb-3">{title}</h4>
                        <p className="text-blue-100 text-sm">
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Exercitationem fugit, ipsa sunt tempora unde vitae!
                        </p>
                    </div>
                    <div className="flex justify-start items-center">
                        {
                            skill.map((ele,i)=>
                                <span className="text-blue-100 text-xs mr-2 " key={i}>{ele}</span>
                            )
                        }
